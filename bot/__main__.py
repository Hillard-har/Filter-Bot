...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="💡 HELP",callback_data="help_match"),InlineKeyboardButton(text="⚜️ MASTER",url="https://t.me/Hillard_Har")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="💡 HELP",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="📫 FEEDBACK",url="https://t.me/Stemlime_bot")]]))
        return
        ...
        text = "Here is the available help for the *{}* module:\n".format(HELPABLE[module].__mod_name__) \
               + HELPABLE[module].__help__
        send_help(chat.id, text, InlineKeyboardMarkup([[InlineKeyboardButton(text="↩️ BACK", callback_data="help_match")]]))
